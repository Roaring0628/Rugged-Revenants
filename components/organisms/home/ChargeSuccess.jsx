...
export default function ChargeSuccess({ closeChargeSuccess }) {
  ...
  return (
    <div className="z-[100] fixed inset-0 w-full h-[100vh] bg-black">
      <div className="w-full h-full relative">
        ...
        {showSuccess && (
          <div
            className="absolute top-8 right-8 text-5xl text-white cursor-pointer"
            onClick={closeChargeSuccess}
          >
            x
          </div>
        )}
